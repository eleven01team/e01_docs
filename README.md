...
3. This script will install all prerequisites which includes:
  -a. Tessera (0.6)
  -b. Go-lang(1.11.1)
  -c. Dependencies packages (libdb-dev, libleveldb-dev, libleveldb-dev, libleveldb-dev, libleveldb-dev, solc, sysvbanner, software-properties-common, default-jdk, maven)
  -d. IPFS (optional)
